...
import { addCourierLine, getCourierManifest } from "@/services/stallionApi";

const columns = ["#","HAWB","Shipper","Importer","Description","Pkgs","Weight","THN","Rate","Cost USD","Freight","CIF TTD","Duty","OPT","VAT","Total"];
...
export default function CourierWorkbench() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0f1115", color: "#eaeef5" }}>
      <TopNav rightSlot={<button onClick={addLine}>+ Add Line</button>} />
